...
4. Project Description. Описание структуры проекта.
    ...
    - Схема задействованных окон:
       > - Главное окно (игровое) → Стартовое меню → Финальное окно.
